...
class ClienteSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        [
            ...
            'fecha_nacimiento' => Carbon::create(04, 04, 1998)->format('d-m-y'),
            'edad' => '25',
        ...
        [
            ...
            'fecha_nacimiento' => Carbon::create(04, 04, 1995)->format('d-m-y'),
            'edad' => '28',
        ...
        [
            ...
            'fecha_nacimiento' => Carbon::create(04, 04, 1990)->format('d-m-y'),
            'edad' => '33',
        ...
        [
            ...
            'fecha_nacimiento' => Carbon::create(04, 06, 1990)->format('d-m-y'),
            'edad' => '33',
